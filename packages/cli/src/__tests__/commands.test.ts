      ...
      results: [
        {
          ...
          author: { username: 'user1', trust_tier: 'registered' },
          signed: false,
          downloads: 10,
          rating_avg: 0,
          rating_count: 0,
        ...
        },
        {
          ...
          author: { username: 'user2', trust_tier: 'scanned' },
          signed: false,
          downloads: 500,
          rating_avg: 3.5,
          rating_count: 10,
      ...
      results: [
        {
          ...
          version: '1.0.0',
          description: 'Test',
          author: { username: 'me', trust_tier: 'registered' },
          signed: false,
          downloads: 0,
          rating_avg: 0,
          rating_count: 0,
      ...
      results: [
        {
          ...
          author: { username: 'newbie', trust_tier: 'registered' },
          signed: false,
          downloads: 0,
          rating_avg: 0,
          rating_count: 0,
      ...
      results: [
        {
          ...
          author: { username: 'tester', trust_tier: 'registered' },
          signed: false,
          downloads: 100,
          rating_avg: 4.0,
          rating_count: 10,
      ...
      results: [
        {
          ...
          author: { username: 'dev', trust_tier: 'verified' },
          signed: true,
          downloads: 500,
          rating_avg: 4.5,
          rating_count: 20,
